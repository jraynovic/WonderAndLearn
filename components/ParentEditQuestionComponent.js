...
class LogInComponent extends Component {
    ...
    componentDidMount(){
        ...
        this.setState({
            ...
            correctAnswer:this.props.navigation.state.params.question.answers[0].answer,
            wrongAnswerOne:this.props.navigation.state.params.question.answers[1].answer,
            wrongAnswerTwo:this.props.navigation.state.params.question.answers[2].answer,
            wrongAnswerThree:this.props.navigation.state.params.question.answers[3].answer,
        })
                ...
                <KeyboardAvoidingView
                    ...
                    <View style={styles.textBoxTitle}>
                        ...
                        <View style={styles.buttonRow}>
                            <TouchableOpacity onPress={()=>this.handleEditQuestion()} style={styles.button}>
...
const styles = StyleSheet.create({
    ...
    title:{
        fontFamily: 'Dosis',color:'#ed553b', marginTop:'5%',marginBottom:60,fontSize:40  ,textAlign: 'center', 
    },
    textBoxTitle:{
        justifyContent:'flex-start',
        marginLeft:50,
